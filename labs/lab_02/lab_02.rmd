...
**A1. 305 departments offered courses with climate in the title. Atmospheric & Oceanic Science offered tge msot. .**
...
**A2.The honors options are interesting because I wouldn't automatically associate that with climate science.**
...
**A3. Business & Management had the most courses in fall 2024, with 174 classes. They also had the most classes with syllabuses at 106. The top courses shift a bit one we consider the syllabus counts—the numbers drastically drop and many humanities courses fall out of the top 5 amounts.**
...
moore_payments<- maryland_expenses |> filter (str_detect(committee_name, "Moore")) 
