...
**Answer: Look at the UMD dataset. Then, take take a look at the "term column." From there, you can summarize the number of classes per term. Label that column "count_classes."**
...
**Answer: Arranged in descending order.**
